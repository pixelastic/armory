...
module.exports = {
  ...
  async type(itemName) {
    ...
    const normalizeHash = {
      ...
      Wakizashi: 'Scimitar',
      'Composite Longbows': 'Bow',
      'Full Mail': 'Heavy Armor',
      'Heavy Crossbows': 'Crossbow',
      'Ioun Stones': 'Miscellaneous',
      'Large Shields': 'Shield',
      'Large Swords': 'Sword',
      'Light Crossbows': 'Crossbow',
      'Long Swords': 'Sword',
      'Medium Shields': 'Shield',
      'Miscellaneous Items': 'Miscellaneous',
      'Plate Mail': 'Heavy Armor',
      'Scimitar/Wakizashi/Ninjatō': 'Scimitar',
      'Short Bows': 'Bow',
      'Short Swords': 'Sword',
      'Silver Amulets': 'Amulet',
      'Small Shields': 'Shield',
      'Splint Mail': 'Medium Armor',
      'Studded Leather Armor': 'Light Armor',
      'Throwing axes': 'Axe',
      'Throwing daggers': 'Dagger',
      'Throwing hammers': 'Hammer',
    };
